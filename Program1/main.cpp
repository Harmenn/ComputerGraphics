...
void InitBuffers()
{
	...
	GLuint uniform_light_pos = glGetUniformLocation(program_id, "lightPos");
...
void InitMaterialLight()
{
	...
	material.ambient_color = glm::vec3(0.2, 0.2, 0.0);
	material.diffuse_color = glm::vec3(0.5, 0.5, 0.0);
}
